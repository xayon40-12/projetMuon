...
{  
  ...
  if(process){
    newHit->SetCreationProcess(process->GetProcessName());
  }
  ...
  /*if(aStep->GetTrack()->GetTrackID() == 1) {
    G4cout << "length: " << G4BestUnit(aStep->GetTrack()->GetTrackLength(),"Length") << "   " << G4BestUnit(aStep->GetTrack()->GetStepLength(),"Length") << G4endl;
  }*/
